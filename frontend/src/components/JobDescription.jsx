...
const JobDescription = () => {
  ...
  // The .some() method in JavaScript is an array method that tests whether at least one element in an array passes a specified test (provided as a function). It returns true as soon as one element satisfies the condition; otherwise, it returns false. It’s useful when you want to check if an array contains an element that meets certain criteria.
